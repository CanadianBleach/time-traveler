...
const clientId = '865e4635c0004d49b740988d9b45e19d'; // your clientId
    ...
    <>
      ...
      >
        <div className="m-6">
          ...
          <button className="button is-success is-inverted is-medium" id="login-button" onClick={loginWithSpotifyClick}> Log in with Spotify </button>
        </div>
        <Test text="farty"></Test>
      </div>
    </section>
    </>
  );
